...
const HospitalDetail = ({
  ...
  const loadReviews = async () => {
    try {
      const res = await fetch(`/service/hospitals/${hospitalId}/reviews`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ hospitalId, rating, content }),
      });
  ...
  const deleteReview = async (id) => {
    ...
    try {
      const res = await fetch(`/service/hospitals/${hospitalId}/reviews/${id}`, {
        method: "DELETE",
      });
