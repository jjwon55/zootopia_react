...
export default function InsuranceInsert() {
  ...
  const [form, setForm] = useState({
    imagePath:'', name:'', slogan:'', coveragePercent:'',
    monthlyFeeRange:'', maxCoverage:'', species:'', joinCondition:'',
    coverageItems:'', precautions:''
  })
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10">
      <h3 className="text-2xl font-bold text-center mb-6">보험상품 등록</h3>
