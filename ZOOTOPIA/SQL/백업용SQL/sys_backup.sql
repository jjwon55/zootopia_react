...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원'
...
CREATE TABLE `parttime_job` (
  ...
  KEY `idx_job_pay` (`pay`),
  KEY `idx_job_start` (`start_date`),
  KEY `idx_job_end` (`end_date`),
...
CREATE TABLE `parttime_job_applicant` (
  ...
  KEY `fk_appl_user` (`user_id`),
  KEY `idx_appl_job_created` (`job_id`,`created_at`),
  CONSTRAINT `fk_appl_job` FOREIGN KEY (`job_id`) REFERENCES `parttime_job` (`job_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_appl_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE `parttime_job_comment` (
  ...
  KEY `idx_cmt_job` (`job_id`,`created_at`),
  KEY `idx_cmt_created` (`created_at`),
  CONSTRAINT `fk_cmt_job` FOREIGN KEY (`job_id`) REFERENCES `parttime_job` (`job_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_cmt_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL
...
CREATE TABLE `lost_animal_images` (
  ...
  KEY `FK_lost_animals_TO_images` (`post_id`),
  CONSTRAINT `FK_lost_animals_TO_images` FOREIGN KEY (`post_id`) REFERENCES `lost_animals` (`post_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE `lost_animal_videos` (
  ...
  KEY `FK_lost_animals_TO_videos` (`post_id`),
  CONSTRAINT `FK_lost_animals_TO_videos` FOREIGN KEY (`post_id`) REFERENCES `lost_animals` (`post_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE `post_comments` (
  ...
  CONSTRAINT `FK_posts_TO_post_comments` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`),
...
CREATE TABLE `post_images` (
  ...
  `post_id` int DEFAULT NULL,
  PRIMARY KEY (`image_id`),
  KEY `FK_posts_TO_post_images` (`post_id`),
  CONSTRAINT `FK_posts_TO_post_images` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE `post_likes` (
  ...
  CONSTRAINT `FK_posts_TO_post_likes` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`),
...
CREATE TABLE `post_report` (
  ...
  `reporter_user_id` INT NOT NULL,        -- 신고자
  `reason_code` ENUM('SPAM','ABUSE','SEXUAL','ILLEGAL','OTHER') NOT NULL,
  `reason_text` VARCHAR(500) DEFAULT NULL, -- 상세 신고 내용
  `status` ENUM('PENDING','REVIEWED','REJECTED','ACTION_TAKEN') 
           NOT NULL DEFAULT 'PENDING',
  `admin_note` VARCHAR(500) DEFAULT NULL,  -- 관리자 메모
  `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `reviewed_at` DATETIME DEFAULT NULL,
  PRIMARY KEY (`report_id`),
  -- FK 연결
...
CREATE TABLE `post_videos` (
  ...
  `post_id` int DEFAULT NULL,
  PRIMARY KEY (`video_id`),
  KEY `FK_posts_TO_post_videos` (`post_id`),
  CONSTRAINT `FK_posts_TO_post_videos` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='태그 목록'
...
CREATE TABLE `user_report` (
  `report_id` BIGINT NOT NULL AUTO_INCREMENT,
  `reported_user_id` INT NOT NULL,     -- 신고당한 유저
  `reporter_user_id` INT NOT NULL,     -- 신고한 유저
  `reason_code` ENUM('SPAM','ABUSE','SEXUAL','ILLEGAL','OTHER') NOT NULL,
  `reason_text` VARCHAR(500) DEFAULT NULL,  -- 기타 사유
  -- ✅ 타겟: 아래 중 하나만 채워짐
